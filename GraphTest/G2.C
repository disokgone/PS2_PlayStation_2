...
vmode_t vmodes[] = {	// PAL_NTSC, width, height, psm, bpp, magh
	...
	,{NTSC, 256, 224, 0, 32, 10}		// PAL_256_224_32
	,{NTSC, 320, 224, 0, 32, 8}		// PAL_320_224_32
	,{NTSC, 384, 224, 0, 32, 7}		// PAL_384_224_32
	,{NTSC, 512, 224, 0, 32, 5}		// PAL_512_224_32
	,{NTSC, 640, 224, 0, 32, 4}		// PAL_640_224_32
};
